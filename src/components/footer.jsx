...
function Footer() {
  return (
    <footer>
      <div className="maxWidth">
        ...
        >
          <g clipPath="url(#clip0_286_54)">
            ...
            />
            <path
              d="M190.253 48.7286H184.77L195.838 25.8618H214.331V30.0348H205.476V35.2257H213.377V39.3648H205.476V44.5556H214.467V48.7286H200.402V44.0467H192.603L190.253 48.7286ZM195.157 39.0255L194.748 39.8398H200.402V27.8974C199.471 30.295 197.723 34.0043 195.157 39.0255Z"
              fill="#162A41"
            />
            <path
              d="M238.512 46.6251C236.332 48.2083 233.585 48.9999 230.27 48.9999C226.592 48.9999 223.606 47.9482 221.313 45.8447C219.02 43.7413 217.873 40.8801 217.873 37.2612C217.873 33.6876 219.065 30.8264 221.449 28.6777C223.856 26.529 226.898 25.4546 230.576 25.4546C233.165 25.4546 235.401 25.9296 237.286 26.8795V32.1043C235.106 30.8603 232.87 30.2383 230.576 30.2383C228.419 30.2383 226.705 30.8829 225.434 32.1721C224.162 33.4388 223.527 35.1351 223.527 37.2612C223.527 39.4099 224.151 41.1176 225.4 42.3842C226.648 43.6508 228.351 44.2841 230.508 44.2841C231.485 44.2841 232.449 44.1371 233.403 43.843V39.5343H229.691V35.0899H238.512V46.6251Z"
              fill="#162A41"
            />
            <path
              d="M256.494 48.7286H242.769V25.8618H248.013V44.1485H256.494V48.7286Z"
              fill="#162A41"
            />
            <path
              d="M273.659 48.7286H259.389V25.8618H273.522V30.0348H264.668V35.2257H272.569V39.3648H264.668V44.5556H273.659V48.7286Z"
              fill="#162A41"
            />
            <path
              d="M285.749 30.1027H283.161V36.5488H285.647C287.917 36.5488 289.053 35.4405 289.053 33.224C289.053 32.2514 288.758 31.4937 288.167 30.9509C287.577 30.3854 286.771 30.1027 285.749 30.1027ZM283.161 48.7286H277.916V25.8618H285.851C288.417 25.8618 290.472 26.5404 292.016 27.8974C293.582 29.2545 294.366 31.0187 294.366 33.1901C294.366 36.4471 292.969 38.6975 290.177 39.9415L296 48.7286H289.734L284.762 40.7897H283.161V48.7286Z"
              fill="#162A41"
            />
          </g>
          <defs>
        ...
        <p style={{ paddingTop: "24px", maxWidth: "60%" }}>
          There are many variations of passages of Lorem Ipsum available, but the majority have
          suffered alteration in some form, by injected humour, or randomised words.
        </p>
        <div className="footerContentDiv">
          <div className="footerContactInformation">
            <div className="footerContactInformationDiv">
              <span className="footerSVGBackgroundColor">
                <svg
                  width="22"
                  height="22"
                  viewBox="0 0 22 22"
              ...
              <span>
                <p className="footerContactFont12px">Ring til os</p>
                <p className="footerContactFont18px">+45 7070 4000</p>
              </span>
            </div>
            <div className="footerContactInformationDiv">
              <span className="footerSVGBackgroundColor">
              ...
              <span>
                <p className="footerContactFont12px">Send en mail</p>
                <p className="footerContactFont18px">4000@dinmaegler.com</p>
              </span>
            </div>
            ...
            <div className="footerContactInformationDiv">
              ...
              <span>
                <p className="footerContactFont12px">Butik</p>
                <p className="footerContactFont18px">Stændertorvet 78, 4000 Roskilde</p>
              </span>
            </div>
          ...
          <div className="footerDickSection">
            ...
            <div>
              <p className="footerFont12px" style={{ fontSize: "12px", color: "#7B7B7B" }}>
                Medlem af
              </p>
              <h4 className="footerFont38px" style={{ fontSize: "38px", color: "#7B7B7B" }}>
                DMS
              </h4>
              <p className="footerFont16px" style={{ fontSize: "16px", color: "#7B7B7B" }}>
      ...
      <div>
        <p className="footerLayout2020">Layout By Jit Banik 2020</p>
      </div>
    </footer>
  );
}
