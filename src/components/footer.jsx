        ...
        <div className="maxWidth">
            <svg width="296" height="49" viewBox="0 0 296 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_286_54)">
                    <path fillRule="evenodd" clipRule="evenodd" d="M0 48.7634V19.3825L26.4428 0.135742L38.2841 8.7583L32.6616 12.6786L26.4428 8.14592L6.49145 22.6582V42.3121L24.5686 42.397V48.7634H0Z" fill="#AAAAAA" />
                    <path fillRule="evenodd" clipRule="evenodd" d="M26.426 48.8142L26.375 19.2468L26.3914 19.2807L52.8511 0.0339458L52.8169 0L79.2595 19.2468V48.7294L42.9862 48.7448V42.2613L72.7683 42.2443V22.5225L52.8169 8.01023L32.9167 22.5564L32.9002 48.8143" fill="#162A41" />
            ...
            <p style={{paddingTop: "24px", maxWidth: "60%"}}>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words.</p>
            <div className="footerContentDiv">
                <div className="footerContactInformation">
                    <div className="footerContactInformationDiv">
                        ...
                        <span>
                            ...
                            <p className="footerContactFont12px">
                                Ring til os
                            </p>
                            <p className="footerContactFont18px">
                                +45 7070 4000
                            </p>
                        </span>
                    </div>
                    ...
                    <div className="footerContactInformationDiv">
                        <span className="footerSVGBackgroundColor">
                            ...
                            <svg width="19" height="24" viewBox="0 0 19 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9.5 0C4.25303 0 0 4.08784 0 9.12969C0 12.1226 3.34721 17.8046 6.06775 21.9285C7.88986 24.6905 11.1101 24.6905 12.9323 21.9285C15.6528 17.804 19 12.1226 19 9.12969C19 4.08725 14.747 0 9.5 0ZM9.5 13.423C6.891 13.423 4.77557 11.3901 4.77557 8.88275C4.77557 6.37544 6.891 4.34248 9.5 4.34248C12.109 4.34248 14.2244 6.37544 14.2244 8.88275C14.2244 11.3901 12.109 13.423 9.5 13.423Z" fill="white" />
                            </svg>
                        </span>
                ...
                <div className="footerDickSection">
                    ...
                    <div className="footerQuickLinks">
                        ...
                        <ul>
                            <li><Link to="propertylist">Boliger til salg</Link></li>
                            <li><Link to="agents">Mæglere</Link></li>
                            <li><Link to="contact">Kontakt os</Link></li>
                            <li><Link to="login">Log ind / bliv bruger</Link></li>
                        </ul>
                    </div>
                    <div>
                        <p className="footerFont12px" style={{ fontSize: "12px", color: "#7B7B7B" }}>Medlem af</p>
                        <h4 className="footerFont38px" style={{ fontSize: "38px", color: "#7B7B7B" }}>DMS</h4>
                        <p className="footerFont16px" style={{ fontSize: "16px", color: "#7B7B7B" }}>Dansk Mægler Sammenslutning</p>
                    </div>
